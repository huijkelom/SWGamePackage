...
/// search for a AudioSource on its gameobject, if non is found it will post a waring in console.
/// </summary>
public class L_Audio : MonoBehaviour
{
    ...
    {
        string newAudioPath = LanguageController.GetImage(IdOfAudioFile);
        ...
        else if (Uri.IsWellFormedUriString(newAudioPath, UriKind.Relative))
        {
